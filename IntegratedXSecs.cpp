...
//			cout << "    Overlay = " << IntegratedXSec(PlotsCC1pReco[0][WhichPlot]) << " \\pm " << IntegratedXSecError(PlotsCC1pReco[0][WhichPlot]) << endl;
			...
			cout << "MC & " << IntegratedXSec(PlotsTrue[0][WhichPlot]) << " \\\\" << endl;
			...
			cout << "v3.0.4 & " << IntegratedXSec(PlotsTrue[8][WhichPlot]) << " \\\\" << endl;
			...
			cout << "v3.0.6 & " << IntegratedXSec(PlotsTrue[1][WhichPlot]) << " \\\\" << endl;
...
//			cout << "    GENIE v3.0.6 MicroBooNE Tune v1 = " << IntegratedXSec(PlotsTrue[2][WhichPlot]) << endl;
			...
			cout << "v2.12.10 & " << IntegratedXSec(PlotsTrue[6][WhichPlot]) << " \\\\" << endl;
			...
			cout << "SuSav2 & " << IntegratedXSec(PlotsTrue[3][WhichPlot]) << " \\\\" << endl;
