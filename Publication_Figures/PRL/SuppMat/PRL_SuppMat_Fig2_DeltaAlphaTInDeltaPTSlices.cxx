...
void PRL_SuppMat_Fig2_DeltaAlphaTInDeltaPTSlices() {
	...
	PlotNames.push_back("DeltaAlphaTPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(0.104); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig69");
	PlotNames.push_back("SerialDeltaAlphaT_DeltaPTPlot_0"); PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(0.32); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,(GeV/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig70");
	PlotNames.push_back("SerialDeltaAlphaT_DeltaPTPlot_2");	PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(0.054); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,(GeV/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig71");
...
//	MCSampleBand.push_back("G21hA"); Label.push_back("G21 hA");  MCColors.push_back(kAzure+9); LineStyle.push_back(kSolid);	
	MCSampleBand.push_back("SuSav2"); Label.push_back("G21"); MCColors.push_back(kGreen-2); LineStyle.push_back(kSolid);
...
//	MCSampleBand.push_back("GENIEv2"); Label.push_back("Gv2");   MCColors.push_back(kOrange+7); LineStyle.push_back(kSolid);
...
//	MCSampleBand.push_back("Genie_v3_0_6_hN2018"); Label.push_back("G18 hN Tune");
	MCSampleBand.push_back("Genie_v3_0_6_NoRPA"); Label.push_back("G18 no-RPA"); MCColors.push_back(kOrange+7); LineStyle.push_back(kSolid);
