...
void PRD_ECalInDeltaPTSlices_Gene() {
	...
	PlotNames.push_back("ECalPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(24.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{GeV\\,^{40}Ar}$]"); SaveFig.push_back("Fig100");
	PlotNames.push_back("SerialECal_DeltaPTPlot_0"); PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(64.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV^{2}/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig101");
	PlotNames.push_back("SerialECal_DeltaPTPlot_1");PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(37.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV^{2}/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig102"); 	
	PlotNames.push_back("SerialECal_DeltaPTPlot_2"); PanelLabels.push_back("(d)"); Min.push_back(0.); Max.push_back(8.5); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV^{2}/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig103");
...
//	Runs.push_back("Run5");
	...
	for (int irun = 0; irun < NRuns; irun++) {
		...
		TString TxtName = "/home/afroditi/Dropbox/Apps/Overleaf/MicroBooNE_KinematicImbalance_PRD_Rename/PRD_XSec_ECalInDeltaPT.tex";
		ofstream myTxtFile;
