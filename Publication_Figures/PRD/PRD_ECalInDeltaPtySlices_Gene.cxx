...
void PRD_ECalInDeltaPtySlices_Gene() {
...
//	PlotNames.push_back("ECalPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(39.9);
	PlotNames.push_back("SerialECal_DeltaPtyPlot_0"); PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(13.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV^{2}/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig116");
	PlotNames.push_back("SerialECal_DeltaPtyPlot_1");PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(49.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV^{2}/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig117");	
	PlotNames.push_back("SerialECal_DeltaPtyPlot_2"); PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(9.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV^{2}/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig118");
...
//	Runs.push_back("Run5");
	...
	for (int irun = 0; irun < NRuns; irun++) {
		...
		TString TxtName = "/home/afroditi/Dropbox/Apps/Overleaf/MicroBooNE_KinematicImbalance_PRD_Rename/PRD_XSec_ECalInDeltaPty.tex";
		ofstream myTxtFile;
