...
void PRD_DeltaPTInCosThetaPSlices_Gene() {
...
//	PlotNames.push_back("DeltaPTPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(44.);
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_0"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(2.99); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig36");
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_1");PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(19.);  Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig37");
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_2"); PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(64.);  Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig38");
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_3");	PanelLabels.push_back("(d)"); Min.push_back(0.); Max.push_back(73.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV/\\textit{c})\\,^{40}Ar}$]"); SaveFig.push_back("Fig39");
...
//	Runs.push_back("Run5");
	...
	for (int irun = 0; irun < NRuns; irun++) {
		...
		TString TxtName = "/home/afroditi/Dropbox/Apps/Overleaf/MicroBooNE_KinematicImbalance_PRD_Rename/PRD_XSec_DeltaPTInCosThetaP.tex";
		ofstream myTxtFile;
...
//			TLegend* leg = new TLegend(0.52,0.81,0.98,0.9);
			...
			BeamOnShapeStat->GetYaxis()->SetTitleOffset(1.12);
			...
			text->DrawLatexNDC(0.17, 0.94, PanelLabels[iplot] + " " + LatexLabel[ Mapping[PlotNames[iplot]] ]);	
