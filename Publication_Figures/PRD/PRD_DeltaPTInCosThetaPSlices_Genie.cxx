...
void PRD_DeltaPTInCosThetaPSlices_Genie() {
...
//	PlotNames.push_back("DeltaPTPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(44.);
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_0"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(3.99); SaveFig.push_back("Fig40");
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_1");PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(19.); SaveFig.push_back("Fig41");	
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_2"); PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(64.); SaveFig.push_back("Fig42");
	PlotNames.push_back("SerialDeltaPT_ProtonCosThetaPlot_3");	PanelLabels.push_back("(d)"); Min.push_back(0.); Max.push_back(73.); SaveFig.push_back("Fig43");
