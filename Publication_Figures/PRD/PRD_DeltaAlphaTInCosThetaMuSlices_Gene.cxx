...
void PRD_DeltaAlphaTInCosThetaMuSlices_Gene() {
...
//	PlotNames.push_back("DeltaAlphaTPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(44.);
	PlotNames.push_back("SerialDeltaAlphaT_MuonCosThetaPlot_0"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(0.021); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig58");
	PlotNames.push_back("SerialDeltaAlphaT_MuonCosThetaPlot_1");PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(0.049); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig59");	
	PlotNames.push_back("SerialDeltaAlphaT_MuonCosThetaPlot_2"); PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(0.11); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig60");
	PlotNames.push_back("SerialDeltaAlphaT_MuonCosThetaPlot_3");	PanelLabels.push_back("(d)"); Min.push_back(0.); Max.push_back(0.17); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig61");
...
//	Runs.push_back("Run5");
	...
	for (int irun = 0; irun < NRuns; irun++) {
		...
		TString TxtName = "/home/afroditi/Dropbox/Apps/Overleaf/MicroBooNE_KinematicImbalance_PRD_Rename/PRD_XSec_DeltaAlphaTInCosThetaMu.tex";
		ofstream myTxtFile;
...
//			TLegend* leg = new TLegend(0.24,0.79,0.68,0.88);
			...
			if (iplot == 0 || iplot == 3) { leg = new TLegend(0.65,0.7,0.85,0.88); }			
			leg->SetBorderSize(0);
			leg->SetTextSize(TextSize);
			leg->SetTextFont(FontStyle);
			leg->SetNColumns(1);
			leg->SetMargin(0.075);
			if (iplot == 0 || iplot == 3) { leg->SetMargin(0.15); }
			leg->SetFillStyle(0);									
