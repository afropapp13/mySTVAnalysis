...
void PRD_DeltaPT_FSI_NoFSI() {
	...
	MCSampleBand.push_back("OverlayGENIE"); Label.push_back("(a) G18,"); FigName.push_back("Fig125");
...
//	MCSampleBand.push_back("GENIEv2"); Label.push_back("(b) Gv2,");
	...
	MCSampleBand.push_back("Genie_v3_0_6_NoFSI"); Label.push_back("(b) G18 NoFSI,"); FigName.push_back("Fig126");
...
//	Runs.push_back("Run5");
	...
	//			TLegend* legData = new TLegend(0.23,0.67,0.67,0.78);
				TLegend* legData = new TLegend(0.53,0.75,0.97,0.87);			
	...
	//			TLegend* legUnc = new TLegend(0.23,0.67,0.67,0.78);
				TLegend* legUnc = new TLegend(0.535,0.69,0.93,0.75);			
	...
	//			TLegend* leg = new TLegend(0.24,0.79,0.68,0.88);
				TLegend* leg = new TLegend(0.53,0.59,0.8,0.69);
				leg->SetBorderSize(0);
