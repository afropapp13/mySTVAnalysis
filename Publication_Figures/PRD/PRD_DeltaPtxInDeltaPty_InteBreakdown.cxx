...
void PRD_DeltaPtxInDeltaPty_InteBreakdown() {
	...
	PlotNames.push_back("SerialDeltaPtx_DeltaPtyPlot_1");Label.push_back("(c)"); Min.push_back(0.); Max.push_back(94.);	
	...
	for (int irun = 0; irun < NRuns; irun++) {
		...
		for (int iplot = 0; iplot < NPlots; iplot ++) {
			...
			for (int igen = 0; igen < NMC; igen++) {
				...
				TLegend* leg = new TLegend(0.24,0.76,0.6,0.86);
				leg->SetBorderSize(0);
				...
				TLegend* legData = new TLegend(0.23,0.56,0.59,0.76);
