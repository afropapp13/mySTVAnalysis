...
void TKI_WienerXSecUncertainty() {
	...
	PlotNames.push_back("DeltaPhiTPlot");  SaveFig.push_back("Fig136"); MaxValue.push_back(39.9);			
	PlotNames.push_back("DeltaPtyPlot");  SaveFig.push_back("Fig137"); MaxValue.push_back(59.9);
	PlotNames.push_back("ECalPlot");  SaveFig.push_back("Fig138"); MaxValue.push_back(34.9);	
