...
void PRD_DeltaPhiTInDeltaPTSlices_Genie() {
	...
	PlotNames.push_back("DeltaPhiTPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(0.36); SaveFig.push_back("Fig80");
	PlotNames.push_back("SerialDeltaPhiT_DeltaPTPlot_0"); PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(1.6); SaveFig.push_back("Fig81");
	PlotNames.push_back("SerialDeltaPhiT_DeltaPTPlot_1");PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(0.34); SaveFig.push_back("Fig82");	
	PlotNames.push_back("SerialDeltaPhiT_DeltaPTPlot_2"); PanelLabels.push_back("(d)"); Min.push_back(0.); Max.push_back(0.044); SaveFig.push_back("Fig83");
