...
void PRD_CosThetaMu_Genie() {
	...
	PlotNames.push_back("MuonCosThetaPlot"); PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(22.); Units.push_back("[$10^{-38}\\frac{cm^{2}}{(GeV/c)\\,^{40}Ar}$]"); SaveFig.push_back("Fig9");
