...
void PRD_DeltaAlphaTInCosThetaPSlices_Gene() {
...
//	PlotNames.push_back("DeltaAlphaTPlot"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(44.);
	PlotNames.push_back("SerialDeltaAlphaT_ProtonCosThetaPlot_0"); PanelLabels.push_back("(a)"); Min.push_back(0.); Max.push_back(0.012); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig66");
	PlotNames.push_back("SerialDeltaAlphaT_ProtonCosThetaPlot_1");PanelLabels.push_back("(b)"); Min.push_back(0.); Max.push_back(0.059); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig67");	
	PlotNames.push_back("SerialDeltaAlphaT_ProtonCosThetaPlot_2"); PanelLabels.push_back("(c)"); Min.push_back(0.); Max.push_back(0.13); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig68");
	PlotNames.push_back("SerialDeltaAlphaT_ProtonCosThetaPlot_3");	PanelLabels.push_back("(d)"); Min.push_back(0.); Max.push_back(0.21); Units.push_back("[$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$]"); SaveFig.push_back("Fig69");
...
//	Runs.push_back("Run5");
	...
	for (int irun = 0; irun < NRuns; irun++) {
		...
		TString TxtName = "/home/afroditi/Dropbox/Apps/Overleaf/MicroBooNE_KinematicImbalance_PRD_Rename/PRD_XSec_DeltaAlphaTInCosThetaP.tex";
		ofstream myTxtFile;
...
//			TLegend* leg = new TLegend(0.24,0.79,0.68,0.88);
			...
			if (iplot == 1 || iplot == 2) { leg = new TLegend(0.65,0.7,0.85,0.88); }			
			leg->SetBorderSize(0);
			...
			myTxtFile << "\\hline" << endl;
			myTxtFile << "\\hline" << endl;			
			myTxtFile << "Bin \\# & Low edge [deg] & High edge [deg] & Cross Section [$10^{-38}\\frac{cm^{2}}{deg\\,^{40}Ar}$] & Uncertainty [$10^{-38} \\frac{cm^{2}}{deg\\,^{40}Ar}$] \\\\" << endl;			
			myTxtFile << "\\hline" << endl;
			myTxtFile << "\\hline" << endl;
