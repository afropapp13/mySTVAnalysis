...
void PRD_DeltaAlphaT_FSI_NoFSI() {
	...
	vector<TString> FigName;	

	MCSampleBand.push_back("OverlayGENIE"); Label.push_back("(a) G18,"); FigName.push_back("Fig127");
...
//	MCSampleBand.push_back("GENIEv2"); Label.push_back("(b) Gv2,");
	...
	MCSampleBand.push_back("Genie_v3_0_6_NoFSI"); Label.push_back("(b) G18 NoFSI,"); FigName.push_back("Fig128");
...
//	Runs.push_back("Run5");
	...
	//			TLegend* legData = new TLegend(0.23,0.67,0.67,0.78);
				TLegend* legData = new TLegend(0.23,0.75,0.67,0.87);			
	...
	//			TLegend* legUnc = new TLegend(0.23,0.67,0.67,0.78);
				TLegend* legUnc = new TLegend(0.235,0.69,0.63,0.75);			
	...
	//			TLegend* leg = new TLegend(0.24,0.79,0.68,0.88);
				TLegend* leg = new TLegend(0.23,0.59,0.5,0.69);
				leg->SetBorderSize(0);
...
//				PlotCanvas->SaveAs("/home/afroditi/Dropbox/Apps/Overleaf/MicroBooNE_KinematicImbalance/Figures/PRD_InteBreakDown_" + MCSampleBand[igen] + "_"+PlotNames[iplot]+"_"+Runs[irun]+"_"+UBCodeVersion+".pdf");
				PlotCanvas->SaveAs("/home/afroditi/Dropbox/Apps/Overleaf/MicroBooNE_KinematicImbalance_PRD_Rename/" + FigName[igen] + ".pdf");
				delete PlotCanvas;						
