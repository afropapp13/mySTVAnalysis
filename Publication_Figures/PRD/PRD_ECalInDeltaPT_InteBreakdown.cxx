...
void PRD_ECalInDeltaPT_InteBreakdown() {
	...
	PlotNames.push_back("SerialECal_DeltaPTPlot_0"); Min.push_back(0.); Max.push_back(64.);
	PlotNames.push_back("SerialECal_DeltaPTPlot_2"); Min.push_back(0.); Max.push_back(8.5);	
...
//	MCSampleBand.push_back("Overlay9NuWro");
	...
	// MCSampleBand.push_back("GENIEv2EffSF");		
	 MCSampleBand.push_back("Genie_v3_0_6_Out_Of_The_Box");	 Label.push_back("(b) Untuned");				
