...
void CompareGenerators(bool PlotGENIE = true, bool PlotGen = false, 
...
//ADD NUWRO !!!!!!!!!!!!!!!
		...
		for (int WhichPlot = 0; WhichPlot < N1DPlots; WhichPlot ++) {	
			...
			for (int WhichSample = 0; WhichSample < NSamples; WhichSample++) {
				...
				//double GlobalMax = TMath::Max(max, maxZero);		
			...
			PlotCanvas->SaveAs("./myPlots/pdf/"+UBCodeVersion+"/BeamOn9/"+Extra+"Generator_XSections_"+PlotNames[WhichPlot]+"_"+Runs[WhichRun]+"_"+UBCodeVersion+".pdf");
