...
void TwoDimWienerSVD_OverlayGenerators(bool PlotGENIE = true, bool PlotGen = false, 
	...
	PlotNames.push_back("SerialDeltaPn_DeltaAlpha3DMuPlot");		
	...
	PlotNames.push_back("SerialDeltaAlphaT_ProtonMomentumPlot");	
	PlotNames.push_back("SerialDeltaAlphaT_DeltaPTPlot");
	PlotNames.push_back("SerialDeltaAlpha3Dq_DeltaPnPlot");
	PlotNames.push_back("SerialDeltaAlpha3DMu_DeltaPnPlot");				
...
//			NameOfSamples.push_back("Genie_v3_0_6_RFG"); Colors.push_back(GiBUUColor); Labels.push_back("G18 RFG Tune");
		...
		if (All) {
			...
			NameOfSamples.push_back("NEUTv5401_LFG_NoFSI"); Colors.push_back(NEUTColor); Labels.push_back("NEUTv540NoFSI");						
			NameOfSamples.push_back("Genie_v3_0_6_Nominal"); Colors.push_back(NEUTColor); Labels.push_back("G18 Nom    ");
			NameOfSamples.push_back("Genie_v3_0_6_NoFSI"); Colors.push_back(GiBUUColor); Labels.push_back("G18 No FSI ");			
...
//		TFile* fUnc = TFile::Open(PathToFiles+UBCodeVersion+"/WienerSVD_UnfoldingUnc_Combined_"+UBCodeVersion+".root","readonly");
		...
		for (int WhichPlot = 0; WhichPlot < N1DPlots; WhichPlot ++) {		
			...
			if (PlotNames[WhichPlot] == "SerialDeltaPn_DeltaAlpha3DqPlot") {
			...
			if (PlotNames[WhichPlot] == "SerialDeltaPn_DeltaAlpha3DMuPlot") {
			...
			if (PlotNames[WhichPlot] == "SerialDeltaAlpha3Dq_DeltaPnPlot") {
			...
			if (PlotNames[WhichPlot] == "SerialDeltaAlpha3DMu_DeltaPnPlot") {
			...
			if (PlotNames[WhichPlot] == "SerialDeltaPn_DeltaAlphaTPlot") {

				SliceDiscriminators.push_back(TwoDArrayNBinsDeltaAlphaT); 
				SliceBinning.push_back(TwoDArrayNBinsDeltaPnInDeltaAlphaTSlices);
