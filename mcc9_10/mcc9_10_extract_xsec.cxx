...
void mcc9_10_extract_xsec(TString OverlaySample = "", bool ClosureTest = false, TString BeamOnSample = "", TString Tune = "") {
...
//	PlotNames.push_back("DeltaPTPlot"); 
	...
	NameOfSamples.push_back("mcc9_10_Overlay9"); if (OverlaySample != "") { NameOfSamples[0] = OverlaySample; }
	NameOfSamples.push_back("mcc9_10_BeamOn9");  if (BeamOnSample != "") { NameOfSamples[1] = BeamOnSample; }
	NameOfSamples.push_back("mcc9_10_ExtBNB9"); 
	NameOfSamples.push_back("mcc9_10_OverlayDirt9");
	NameOfSamples.push_back("mcc9_10_GenieOverlay");	 
...
//	Runs.push_back("Combined");			
	...
	for (int WhichRun = 0; WhichRun < NRuns; WhichRun++) {
		...
		for (int WhichSample = 0; WhichSample < NSamples; WhichSample ++) {
			...
			if (NameOfSamples[WhichSample] == "mcc9_10_BeamOn9") { DataIndex = WhichSample; }

			if (
				NameOfSamples[WhichSample] == "mcc9_10_BeamOn9" || 
				NameOfSamples[WhichSample] == "mcc9_10_ExtBNB9" || 
