...
//	Runs.push_back("Run3");
	...
	for (int WhichRun = 0; WhichRun < NRuns; WhichRun++) {
		...
		for (int WhichPlot = 0; WhichPlot < N1DPlots; WhichPlot ++) {	
			...
			PlotsCC1pReco[0][WhichPlot]->GetYaxis()->SetRangeUser(XSecRange[PlotNames[WhichPlot]].first,XSecRange[PlotNames[WhichPlot]].second);
...
//			PlotsReco[0][WhichPlot]->Draw("e1x0 same");
			...
			PlotsTotalReco[0][WhichPlot]->SetMarkerSize(1.);
...
//			PlotsTotalReco[0][WhichPlot]->Draw("e1x0 same");
			...
			//PlotsTrue[0][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[1][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[2][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[3][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[4][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[5][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[6][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[7][WhichPlot]->SetLineWidth(1);
			...
			//PlotsTrue[8][WhichPlot]->SetLineWidth(1);
